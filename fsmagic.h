...
/* This is a slightly modified version of linux_fsinfo.h from the Linux kernel sources.
 * This is included as a header so that one doesn't need the kernel-headers installed
 * to compile this. */
